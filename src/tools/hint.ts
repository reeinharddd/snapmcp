  ...
  server.tool(
    ...
    async ({ topic }) => {
      const hints: Record<string, string> = {
        ...
        document: "Create multi-capture documents with `capture_to_document` (up to 30 captures) in markdown, HTML, or PDF format. Each capture gets a caption. HTML output embeds images as base64 for portability. PDF uses print-quality rendering.",
