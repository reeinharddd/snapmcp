...
<!-- Real captures generated by snapmcp the same way your agent will produce them (nord theme, window chrome, soft shadow). -->

| Capture | Preview |
|---------|---------|
| Terminal (real detected colors) | <img src="assets/demo-terminal.png" alt="terminal capture" width="300"/> |
| Code (Shiki syntax) | <img src="assets/demo-code.png" alt="code capture" width="300"/> |
| Diff (green/red) | <img src="assets/demo-diff.png" alt="diff capture" width="300"/> |
